...
import org.huh.util.PropertyManager;
 ...
 * It is a simple example of the use of the Java Debug Interface. Usage: java
 * Trace <options> <class> <args> <options> are: -output <filename> Output trace
 * to <filename> -all Include system classes in output -help Print this help
 * message <class> is the program to trace <args> are the arguments to <class>
 * 
 * 
 * @author Robert Field
 */
public class Trace {
	...
	public static void main(String[] args) {
		String mainclass=PropertyManager.getProperty("mainclass");
		String [] a={mainclass};
		new Trace(a);
	}
	...
	Trace(String[] args) {
		...
		VMLauncherHelper vlh=new VMLauncherHelper(Bootstrap.virtualMachineManager(),null);
		vm = vlh.getTargetVM(sb.toString());
